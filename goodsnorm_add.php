<?php require_once(dirname(__FILE__).'/inc/config.inc.php');IsModelPriv('goodsnorm'); 
$_LANG['js']['color']    	= '颜色';
$_LANG['js']['pic']    		= '图片';
               	  ...
               	  <table border="0" cellspacing="0" cellpadding="0" align="left" id="tboption" >
                      <tr>
                          <td> 
                             ...
                             <span class="dn" name="image[]">图片：<input type="text" name="norm[0][pic]" id="pic_1"  class="v5-input in180" /> <a href="javascript:;" onclick="showupload('pic_1')">上传</a></span>
                          </td>
                      </tr>
                  </table>
              </td>
