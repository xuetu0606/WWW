    ...
    <div class="main">
        <div class="conditions">
            ...
            <?php 
                ...
                // echo
                // '<div class="type zhiye" id="1">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 1){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                //     '</ul>
                // </div>';
                // echo
                // '<div class="type zhiye" id="33">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 33){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo
                // '<div class="type zhiye" id="218">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 218){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo
                // '<div class="type zhiye" id="257">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 257){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo
                // '<div class="type zhiye" id="328">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 328){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo
                // '<div class="type zhiye" id="375">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 375){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo
                // '<div class="type zhiye" id="412">
                //     <span>职业：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>';
                //         foreach($job_type as $item){
                //             if($item['level'] == 2 && $item['pre_id'] == 412){
                //                 echo '<li><a href="javascript:void(0);" name="'.$item['id'].'" onclick="next(this);">'.$item['name'].'</a></li>';
                //             }
                //         }
                // echo
                ...
                // </div>';
                // echo 
                // '<div class="type gongzhong" id=>
                //     <span>工种：</span>
                //     <ul>
                //         <li><a href="javascript:void(0);">不限</a></li>
                //         <li><a href="javascript:void(0);">商务服务</a></li>
                //         <li><a href="javascript:void(0);">安装维修</a></li>
                //         <li><a href="javascript:void(0);">计算机网络玩儿否</a></li>
                //         <li><a href="javascript:void(0);">劳务工务</a></li>
                //     </ul>
                // </div>';
            ?>
            <div class="type quyu">
